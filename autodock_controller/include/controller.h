    ...
    class autodock_controller :public rclcpp::Node{
        public:
            autodock_controller():Node("autodock_controller"){
                ...
                action_service = this->create_service<autodock_msgs::srv::DockingAction>(
                    "autodock_controller/set_action", std::bind(&autodock_controller::handle_service, this, _1, _2, _3));
        ...
        private:
            rclcpp::Service<autodock_msgs::srv::DockingAction>::SharedPtr action_service;
